    ...
    <>
      ...
      <section className="shadow-lg bg-white rounded-lg p-6 w-7/12  mx-8 my-8">
        ...
        <p className="text-black leading-9">
          ...
          apartment is located in safe residential compound and it is on the 4th
          floor. It has living and dinning room with balcony, kitchen, master
          bedroom with it’s own shower room, two bedrooms with common shower
          room and garage for one car. The building comes with elevator and
          terrace on roof top. The rate is 1,600 USD or 160,000 Birr per month
          and negotiable.
        </p>
      </section>
      <section className="shadow-lg bg-white rounded-lg p-6 w-7/12  mx-8 my-8">
